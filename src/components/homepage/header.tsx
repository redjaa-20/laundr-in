import { Menu01Icon, WhatsappIcon } from "@hugeicons/core-free-icons";
...
export function HomepageHeader() {
  return (
    <header className="h-20 sticky top-0 z-50 flex items-center bg-background px-4 pr-3 md:px-4 xl:px-0">
      <div className="w-full max-w-6xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* <Button size="icon" variant="ghost" className="h-11 lg:hidden">
            <HugeiconsIcon
              icon={Menu01Icon}
              strokeWidth={2}
              className="size-6"
